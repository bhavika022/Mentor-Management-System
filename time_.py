...
from b import Session, Schedule
import datetime
...
class DateEntry(tk.Frame):
    def __init__(self, master, frame_look={}, **look):
        args = dict(relief=tk.SUNKEN, border=4)
        ...
        self.entry_1.config(font=("Courier", 44))
        self.label_1.config(font=("Courier", 44))	
        self.entry_2.config(font=("Courier", 44))
        self.label_2.config(font=("Courier", 44))
        self.entry_3.config(font=("Courier", 44))
    ...
    def get(self):
        datee = self.entry_1.get()+self.entry_2.get()+self.entry_3.get()
        d=datetime.datetime.strptime(datee, "%d%m%Y").date()
        return d
